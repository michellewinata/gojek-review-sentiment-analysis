...
Fokus utama proyek adalah membandingkan performa model (Naive Bayes, Logistic Regression, Support Vector Machine (SVM), dan Random Forest) pada dua dataset dengan karakteristik berbeda (dataset kecil vs dataset besar).
